...
|------|-----------|-----------|---------------|
| YouTube | You create videos | 45% revenue | 0% — leave and lose everything |
| Upwork | You do the work | 20% fee | 0% — reputation locked |
| AppStore | You build apps | 30% commission | 0% — banned at their will |
| Banks | You save money | Inflation eats it | 0% — they print, you lose |
| PayPal | You earn abroad | 5-7% in fees + frozen | 0% — accounts frozen at will |

### The Pattern

1. **Platforms** → You create. They profit. You leave. Nothing remains.
...
## 5. Pillar I: The Crust — Own Your Reputation

### The Problem

On every platform today, your reputation is held hostage:
- 5,000 reviews on Airbnb? Switch to VRBO — start from zero
- Top Rated on Upwork? Leave — your score stays behind
...
Your Crust is your on-chain identity — a soulbound, dynamic record of everything you've built.
...
│  Tier: ████████░░ Golden Crust      │
│  Bakes Completed: 34                 │
│  Keeper Since: March 2026            │
│  Skills: ✅ Verified on-chain        │
│  Oven: Solana (multichain ready)     │
│                                      │
│  ⚡ Portable · 🔒 Unsellable         │
│  🌐 Works in every Oven             │
└──────────────────────────────────────┘
...
*"Every loaf you bake adds to your Crust. The Crust can't be bought — only earned through the work of your hands."*

---

## 6. Pillar II: The Handshake — Trade Without Walls
...
Baker A (Istanbul) ←→ Baker B (São Paulo)
         │
    ┌────┴────┐
    │ RECIPE  │  ← Smart contract with clear terms
    └────┬────┘
         │
    Code verifies → Escrow releases → Crust updated
         │
...
- **Borderless**: Istanbul to São Paulo in seconds, not days
...
- Give away tokens → dilutes believers
...
Each step feeds the next. No step requires outside intervention. The flywheel is self-sustaining — just like sourdough starter.
...
The longer you hold without selling, the thicker your Crust — and the greater your Harvest.

| Tier | Requirement | Harvest Weight | Benefits |
|------|------------|---------------|----------|
| 🫓 Fresh Dough | Hold any amount | — | Community access, Baker identity, Crust begins |
| 🍞 Rising Dough | 30 days holding | 1x | Harvest eligibility, reduced Pinch, DAO voting |
| 🥐 Golden Crust | 90 days holding | 1.5x | Sourdough Circle creation, Recipe proposals, minimum Pinch |
| 👑 Eternal Starter | 365 days holding | 2x | Governance veto, Elder Baker status, founding privileges |
...
20% of all protocol revenue flows to the Commons Bakery automatically. No vote needed to fund it — only to spend it.
...
Multichain deployment — every blockchain is an Oven. No-code platform builder for everyone. The Bakery DAO with full governance. Global Baker network. The Civilization rises.
...
- Progressive decentralization → full DAO

### User Safety
- Non-custodial — users control their wallets
- No personal information required
- Rate limiting — anti-spam, anti-manipulation
- Soulbound identity — can't be stolen or faked
...
```
CrustScore = Σ(bake_value × completion × time_factor × tier_bonus)
