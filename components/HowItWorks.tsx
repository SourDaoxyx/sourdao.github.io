...
const steps = [
  {
    ...
    desc: "Join the protocol in seconds. Phantom or Solflare — your keys, your identity.",
  ...
  },
  {
    ...
    desc: "Every action is recorded on-chain. Your Civilization ID evolves as you grow in the ecosystem.",
    example: "5 tiers: Unverified → Sovereign",
